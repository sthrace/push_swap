...
static void	ft_b_to_a(t_array *data)
{
	...
	mid_b = ft_get_value(data->stack_b, data->size_b, data->size_a / 2, -1);
	while (mid_b != ft_minmax(data->stack_b, data->size_b, 1, -1))
	{
		top = 0;
